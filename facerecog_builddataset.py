...
face_cascade = cv2.CascadeClassifier('haarcascade_frontalface_alt2.xml') # Detect object in video stream using Haarcascade Frontal Face
face_id = 2  # For each person,there will be one face id
...
while(True):
    ...
    if cv2.waitKey(100) & 0xFF == 27:                   # To stop taking video, press 'Esc'
        break
    elif count>10:                                     # If image taken reach 100, stop taking video
        break
